...
export const metadata: Metadata = {
  title: 'Page Not Found · Bucktown Bulls Baseball',
  ...
  return (
    <main className="min-h-[60vh] flex items-center justify-center px-6 py-20">
      <div className="text-center max-w-md">
        ...
        <p className="mt-4 text-base text-[var(--bb-stone)]">
          The link may be old, or the page may have moved. Try heading back to our home page.
        </p>
        <Link
          href="/"
          className="mt-8 inline-flex items-center justify-center px-6 py-3 rounded-md font-semibold bg-[var(--bb-navy)] text-white hover:opacity-90 transition-opacity"
        >
          Back to home
        </Link>
      </div>
