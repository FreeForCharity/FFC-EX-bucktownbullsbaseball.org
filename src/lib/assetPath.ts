 ...
 *
 * When deployed to GitHub Pages at freeforcharity.github.io/FFC-EX-bucktownbullsbaseball.org/,
 * all assets need to be prefixed with the repository name.
 *
 * For the custom domain (bucktownbullsbaseball.org / staging.bucktownbullsbaseball.org),
 * no basePath is needed.
 *
